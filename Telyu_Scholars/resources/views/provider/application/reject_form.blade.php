            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea 
                        ...
                        id="rejection_reason" 
                        rows="5" 
                        class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md @error('rejection_reason') border-red-500 @enderror" 
                        placeholder="e.g., Application incomplete, GPA minimum not met, missing required documents..."
