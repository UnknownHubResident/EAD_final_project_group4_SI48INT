...
<div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-8">
    ...
    {{-- 2. System Info Box (Menggantikan teks konfirmasi routing) --}}
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {{-- Action 3: Review Applications (Placeholder) --}}
            <div class="p-5 bg-gray-50 border border-gray-200 rounded-xl opacity-60 cursor-not-allowed flex items-center gap-4">
                ...
                <div>
                    <h4 class="font-bold text-gray-500">Review Applications</h4>
    ...
    <div class="pt-6 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p class="text-sm text-gray-500">
            Role: <span class="font-mono bg-gray-100 text-gray-700 px-2 py-0.5 rounded">{{ Auth::user()->role }}</span>
        </p>
